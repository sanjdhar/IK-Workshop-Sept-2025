...
from tasks import JobSearch, Analysis, SalaryFocusedSearch, CompanyTargetedSearch, EntryLevelSearch, QuickSearch
...
def get_search_inputs(search_type="quick"):
