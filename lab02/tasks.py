...
QuickSearch = Task(
    ...
    Capture any links or URLs to the job openings. Provide a rapid overview of current market opportunities with minimal filtering.
    Focus on speed and breadth of results rather than detailed analysis.""",
    expected_output="Output needs to be nicely formatted markdown text. Use tables where appropriate. A quick summary of current {title} job opportunities with basic details. Makesure to incude and application links or URLs. that can be cliked to get more information.",
    agent=JobSearchAgent,
